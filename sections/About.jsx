...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Metaversus" textStyles="test-center" />
      <motion.p variants={fadeIn('up', 'tween', 0.2, 1)} className="font-normal text-center text-secondary-white sm:text-[32px] text-[20px] mt-[8px]">
      ...
      <motion.img variants={fadeIn('up', 'tween', 0.3, 1)} src="/arrow-down.svg" alt="arrow-down" className="object-contain w-[18px] h-[28px] mt-[28px]" />
    </motion.div>
  </section>
);
